 ...
 *
 * TODO: Implement server-side upload gating via Edge Function
 * - This currently uploads directly from client (UNSAFE - no entitlement check)
 * - Should call Edge Function to get signed upload URL
 * - Edge Function checks: auth, family membership, Cloud Plus active
 * - See docs/UPLOAD_GATING.md for implementation details
 *
